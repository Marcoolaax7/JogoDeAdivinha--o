    ...
    static void Main(string[] args)
    {
        ...
        static void ExecutarPartida(int tentativasMaximas, int numeroMaximo)
        {
            ...
            for (int tentativa = 1; tentativa <= tentativasMaximas; tentativa++)
            {
                ...
                Console.WriteLine($"Digite D para pedir uma dica");
                Console.Write($"Digite um número entre 1 e {numeroMaximo}: ");
                string? opcaoEscolhida = Console.ReadLine();

                if (opcaoEscolhida == "D" || opcaoEscolhida == "d")
                {
                    if (dicaJaFoiDada == true)
                    {
                        Console.WriteLine("A dica ja foi usada");
                        Console.ReadLine();
                        tentativa--;
                        continue;
                    }
                    ...
                    {
                        Console.WriteLine("Dica: o numero é par");
                    }
                    
                    else
                    {
                        Console.WriteLine("Dica: o numero secreto é ímpar");
                    }
                ...
                int numeroEscolhido = Convert.ToInt32(opcaoEscolhida);
                ...
                {
                    pontuacao -= 20;
                    Console.WriteLine("Muito pertoo!!");
                }
